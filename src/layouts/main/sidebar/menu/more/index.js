...
export default function More() {
    return (
        <Popover className="relative group outline-none">
                    ...
                    {({open}) => (
                        <>
                            ...
                            <Disclosure.Panel>
                                ...
                                <button onClick={()=>setModal("appearance")} to="/" className="w-full flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[color:var(--background-secondary)] transition-colors">
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                                        <path
                                            fill="currentColor"
